...
export const config = {
  ...
  packagefiles: [
    {
      src: './releasefiles/plugins/system/kicksportsmanager/**/**',
      dest: 'sourcefiles/plg_system_kicksportsmanager'
    },
    {
      src: './releasefiles/media/plg_system_kicksportsmanager/**/**',
      dest: 'sourcefiles/plg_system_kicksportsmanager/media'
    },
  ],
  archiver: [
    {
      destination : 'archives/',
      name: 'plg_system_kicksportsmanager',
      suffixversion: true,
      types: [
        {
          extension: '.zip',
